                    ...
                    <form role="form" class="parsley-examples" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col-6">
                                <div class="form-group row">
                                    <label for="hori-pass1" class="col-4 col-form-label">Sub Category<span
                                                class="text-danger"></span></label>
                                    <div class="col-7">
                                        <select class="form-control" required name="sub_cate_id" id="sub_category">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8 col-md-8">
                                            <input id="hori-pass1" type="text" placeholder="Enter Product Quantity"
                                                   name="quantity[]" required value="" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="row mt-3">
                                        ...
                                        <div class="file-upload">
                                            <div class="file-select">
                                                ...
                                                <input type="file" name="product_image"
                                                       class="chooseFile  file" multiple
                                                       id="uploadImage">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea rows="5" class="form-control" name="product_description"></textarea>
                            </div>
                            <div class="col-md-6">
...
<script>
    ...
    $('.add').click(function () {
        ...
        $('.addRow').append('<div class="row" id="row' + i + '">' +
            ...
            '<div class="col-8">' +
            '<select class="form-control" required name="quantity_type[]"><option value="">Select type</option><?php foreach ($getType as $type) { ?><option value="<?php echo $type['quantity_type_id'] ?>"><?php echo $type['quantity_name'] ?></option><?php } ?></select>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '<div class="col-md-3">' +
